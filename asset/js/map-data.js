...
var siteI18nData = {
    "1": {
        ...
        "openingHours": "9 a.m. to 6 p.m., no admission after 5:30 p.m.",
    ...
    "3": {
        "name": "Praceta do Museu de Macau",
    ...
    "6": {
        "name": "Guia Fortress",
        "location": "St. Dominic's Square",
        "openingHours": "Fortress: 9 a.m. - 6 p.m.",
    ...
    "7": {
        ...
        "location": "Rua Luis Gonzaga Gomes, 431, basement (Tourism Activities Centre-CAT)",
        "openingHours": "",
        "description": "Opened 1993 to celebrate the 40th anniversary of the Macau Grand Prix, which features a number of automobile and motorbike races and takes place every year in November. It started in 1954 due to the enthusiasm of a group of Macao residents and the support of the authorities. Today it is an international sports event that attracts thousands of tourists and racing enthusiasts to Macao, to watch the classic \"Guia Race\" and the \"Formula 3 Grand Prix\". As it takes place on a street circuit, which inevitably leads to a comparison with Monte Carlo, the Macau Grand Prix has been developing into a race that, due to the exactness and the need for precision which it imposes on the drivers, has had the participation of great names of the motor racing participating and which has also served as a launching platform for many other names, the visitor will certainly recognise while visiting the Grand Prix Museum. ",
        "image": "https://ws1.sinaimg.cn/large/9130c6a9gy1fsvkphcbpkj20ck08cjxg.jpg",
    ...
    "8": {
        ...
        "location": "Avenida da Amizade e Avenida Dr. Sun Yat-Sen, Macau",
        "openingHours": "",
    ...
    "9": {
        ...
        "openingHours": "",
        "description": "Macao Science Center was designed by world renowned architect Mr. I.M. Pei and Pei Partnership Architects. With a gross floor area of 20,000 square metres, Macao Science Center consists of the Exhibition Center, the Planetarium and the Convention Center. ",
    ...
    "12": {
        ...
        "openingHours": "Observation Deck Weekdays: 10am-10pm<br>Weekends & Public Holidays:9am-10pm",
    ...
    "15": {
        "name": "Almound cakes",
        "location": "1 Rua do Tassara, Coloane Town Square, Macau",
        "openingHours": "",
    ...
    "16": {
        ...
        "location": "The Venetian® Macao, Estrada da Baía de N. Senhora da Esperança, s/n, Taipa, Macao SAR, P.R. China",
        "openingHours": "",
    ...
    "18": {
        "name": "SANDS SHOPPES",
        "location": "Shoppes at Venetian, Shoppes at Parisian, Shoppes at Four Seasons, Sands Macao) ",
        "openingHours": "",
    ...
    "19": {
        ...
        "location": "Shop 3009-3010, Level 3, Shoppes at Cotai Central, Sands Cotai Central",
        "openingHours": "",
    ...
    "21": {
        ...
        "location": "Macao Giant Panda Pavilion, Seac Pai Van Park",
        "openingHours": "",
    ...
    "22": {
        ...
        "location": "Rua do Caetano, Largo Eduardo Marques, Coloane",
        "openingHours": "",
        "description": "Built in 1928, this chapel follows the baroque style of Macao's major churches. It has a cream and white facade with oval windows and a bell tower. It stands behind the monument commemorating the local victory over pirates in 1910.        ",
    ...
    "25": {
        "name": "澳门Macao Light Festival光影节",
